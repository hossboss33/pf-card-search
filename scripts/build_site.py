...
# 32 KB reads). So both are raised together. 32 KB is the ceiling that
# actually works: 64 KB pages hang the vendored worker (measured locally and
# deployed — queries never return); do not raise this past 32768.
PAGE_SIZE = 32768
